var $User = (function () {
        ...
        return {
            Browser: { IE: c, IE6: e, IE9: c && i.indexOf("MSIE 9.0") > 0, Opera: !!window.opera, WebKit: i.indexOf("AppleWebKit/") > -1, Gecko: i.indexOf("Gecko") > -1 && i.indexOf("KHTML") == -1 },
            Server: {
                List: [
                    ["1号(深圳电信)", "http://pvz1.lonelystar.org/", "NaN"],
                    ["2号(浙江联通)", "http://pvz2.lonelystar.org/", "NaN"],
                    ["3号(浙江电信)", "http://pvz3.lonelystar.org/", "NaN"],
                    ["4号(浙江电信)", "http://pvz4.lonelystar.org/", "NaN"],
                ],
                SpeedURL: "",
                DataURL: "",
                SpeedInx: 0,
            ...
            Visitor: { UserName: "Guest", UserAuthority: 0, Progress: 1, SelectServerT: 0, NowStep: 1, TimeStep: 10, SaveLvl: 1, SaveLvlCallBack: null },
        };
    })(),
    oSym = {
        Init: function (b, a) {
    ...
    oS = {
        ...
        Init: function (e, g, b, d) {
            var c,
                a = window;
            e.LoadMusic ? (PlayMusic(e.LoadMusic), NewAudio({ source: "Look up at the Sky", loop: true })) : PlayMusic((e.LoadMusic = "Look up at the Sky"));
            NewAudio({ source: "groan2" });
            if (b != d) {
                for (c in b) {
            ...
            $User.isAuthorWebsite &&
                oS.LevelEName != 0 &&
                (ClearChild($("JSPVZAjax")), NewEle("JSPVZAjax", "script", 0, { src: $User.Server.DataURL + "asp/SaveUserPosition.asp?l=" + escape(oS.LevelName), type: "text/javascript" }, document.body));
        ...
        LoadTips: function () {
            var b = NewEle("dTips", "div", "position:absolute;color:#fff;top:450px;width:100%;text-align:center;font-size:16px", "", EDAll),
                a = [
                    "This game has a built-in speed control feature in the game settings, so stop complaining about the slow pace! Okay, dear!!",
                    "This game has a level selection feature. Please choose in the game settings!",
                    "Only registered users can automatically save their level progress. Unregistered users need to select the level manually each time they play.",
                    "Don’t know how to turn off the sound? Please check the mute option in the game settings!",
                    "Don’t forget, there’s an “auto-collect sun” feature in the game settings for lazy players!",
                    "Don’t know how to play? Click “Start” at the bottom left, then click the option on the tombstone on the right to begin. If it’s your first time, click “Adventure”!",
                    "Is this a game for 3-year-olds? So childish! Dear, if you’ve played the original Plants vs. Zombies, you wouldn’t think that way.",
                    "Is this a knockoff? Yes, this is purely a personal practice project that was later released online for free to help people pass the time when bored.",
                    "The development of this web version is really slow! That’s right, because I have very limited spare time, so please understand!",
                    "For first-time players, please start from level one. There will naturally be a tutorial to guide you step by step.",
                    "Why can’t you see the sun or zombies? Check the ad blocker in your browser—it might be messing things up!",
                    "The game is too easy? At your current progress, you can try using the speed adjustment feature to play at a faster pace.",
                    "Is anyone here? There must be some live players around! Open the chat button and join the online conversation!",
                    "Why is it so laggy? If you’re using IE6-8, please switch to better browsers like IE9, Chrome, Firefox, or Opera!",
                    "If you support me, thank you so much! Please keep supporting me as always! And while you’re at it, could you please click that thing~...?",
                    "What language is this written in? JavaScript, a simple yet magical language—pure JS!",
                ];
            b.innerHTML = '<span style="font-weight:bold">Tip: </span><span>' + a[Math.floor(Math.random() * a.length)] + "</span>";
        },
        LoadProgress: function (r, l, a, t, b) {
            ...
            p.PicNum = w += i.length;
            r = i.length;
            y.setAttribute("title", "If loading takes too long or you don’t want to wait for preloading, you can try clicking this button to enter the game directly.");
        ...
        CheckImg: function (b, a) {
            ...
            $("sFlagMeterTitleF").innerHTML = '<span style="cursor:pointer;font-family:Yahei Mono;color:#fff">LOADING...(<span style="cursor:pointer;color:#ff0">Enter the game directly</span>):(' + c.AccessNum + "/" + c.PicNum + ")</span>";
            $("imgFlagMeterFull").style.clip = "rect(0,auto,21px," + (b + 11) + "px)";
            if (c.AccessNum == c.PicNum) {
                oS.Lvl == 0 && PlayAudio("groan2");
                if (c.MustAllReady) {
                    $("sFlagMeterTitleF").innerHTML = '<span style="cursor:pointer;font-family:Yahei Mono;color:#fff">The game finished loading! (<span id="ADTimer" style="cursor:pointer;color:#005"></span>)</span>';
                    c.LoadReady(c);
                }
            }
        },
        LoadReady: function (f) {
            ...
            if (f.CenterContent) {
                ...
                if (oS.MustAllReady && oS.DisplayAD) {
                    ...
                    if (b > 0) {
                        ...
                        (function (g) {
                            var h = $("ADTimer");
                            h && ($("ADTimer").innerHTML = '<span style="text-decoration:underline;color:#ff0">Click here to start</span>');
                ...
                oS.DisplayAD = false;
                $("dAdFlash").innerHTML =
                    '<iframe name="fGGAdsense" marginwidth="1" marginheight="1" height="280" width="336" scrolling="no" border="0" frameborder="0" src="js/ggadsense.htm?' +
                    Math.random() +
                    '"></iframe><br><div style="font-family:arial,sans-serif;font-size:11px;position:absolute;left:300px;width:200px">Google AD (broken)</div>';
            ...
            delete f.LF;
            delete f.ZF;
            var a = { background: "url(" + f.backgroundImage + ") no-repeat", visibility: "visible" };
                    ...
                    ? oSym.addTask(
                          ...
                          [
                              NewEle(
                                  ...
                                  "div",
                                  "line-height:50px",
                                  { innerHTML: (Math.floor(g.UserAuthority) == "255" ? '<span style="color:#0F0;font-weight:bold">&lt;' + g.UserName + "&gt;</span>" : "&lt;" + g.UserName + "&gt;") + "'s house" },
                                  EDAll
                              ),
                          ]
                      )
        ...
        ScrollScreen: function () {
            (EDAll.scrollLeft += 25) < 500
                ...
                : (DisplayZombie(), SetVisible($("dMenu")), oS.CanSelectCard ? SetVisible($("dTop"), $("dSelectCard"), $("dCardList")) : (AutoSelectCard(), oSym.addTask(200, oS.ScrollBack, [LetsGO])));
        },
    ...
    oCoord = {
        1: function () {
            ...
            GetX = function (a) {
                return $SEql(a, { "-2": -50, "-1": 100, 0: 140, 1: 187, 2: 267, 3: 347, 4: 427, 5: 507, 6: 587, 7: 667, 8: 747, 9: 827, 10: 865, 11: 950 });
            };
            GetY = function (a) {
        ...
        2: function () {
            ...
            GetY1Y2 = function (a) {
                return $SEql(a, { 0: [0, 85], 1: [86, 170], 2: [171, 263], 3: [264, 367], 4: [368, 439], 5: [440, 531], 6: [532, 600] });
            };
            GetX1X2 = function (a) {
                return $SEql(a, {
                    "-2": [-100, -49],
            ...
            oS.GifHTML = '<img style="position:absolute;left:253px;top:278px" src="images/interface/background' + (oS.DKind ? 3 : 4) + '_2.gif">';
    ...
    oP = {
                  ...
                  (r.MonPrgs = function () {
                      ...
                      !--u.NumZombies &&
                          (i < u.FlagNum
                              ...
                              : (u.FlagToEnd(),
                                $User.isAuthorWebsite &&
                                    $User.Visitor.UserName != "Guest" &&
                                    (ClearChild($("JSPVZAjax")),
                                    f.SaveLvl && NewEle("JSPVZAjax", "script", 0, { src: $User.Server.DataURL + "asp/UserSave.asp?Lvl=" + (s = oS.LvlEName) + "&T=" + (oSym.Now - oS.StartTime), type: "text/javascript" }, document.body)),
                                f.SaveLvlCallBack && f.SaveLvlCallBack({ UserName: f.UserName, SunNum: oS.SunNum, Lvl: s, T: oSym.Now - oS.StartTime }),
                                !isNaN(Math.floor(s)) && ((t = $("dAdventure")), ($User.Visitor.Progress = ++s), (t.firstChild.innerHTML = Math.ceil(s / 10)), (t.childNodes[1].innerHTML = (s = s - Math.floor(s / 10) * 10) ? s : s + 1)),
                                NewEle("DivA", "div", "position:absolute;width:900px;height:600px;background:#FFF;filter:alpha(opacity=0);opacity:0;z-index:255", 0, EDAll),
                                PauseGame($("dMenu0"), 1)));
                  }))
                : (r.MonPrgs = function () {});
            (!a || !a.FlagToEnd) &&
        ...
        AddZombiesFlag: function (d) {
            ...
            for (e in c) {
                Math.floor(e) < a ? SetStyle(c[e], { visibility: "visible", left: 150 - (e - 1) * b + "px" }) : SetVisible(c[e]);
            }
            PlayAudio("awooga");
            $User.HTML5 &&
                (function () {
        ...
        moveTo: function (g, f, c) {
            ...
            while (e--) {
                (o = b[e]).id == g &&
                    ...
                    }).RefreshTime = b.RefreshTime = oSym.Now),
                    (e = 0));
            }
        },
    ...
    WhichMouseButton = function (a) {
        a = window.event || a;
        var b = $User.Browser;
        return !b.Gecko ? $SEql(a.button, { 1: 1, 0: b.IE ? 2 : 1, 2: 2, default: 1 }) : $SEql(a.which, { 1: 1, 3: 2, default: 1 });
    },
    ...
    GroundOnmousemove1 = function (j) {
        ...
        SetStyle($("MovePlant"), { left: d - 0.5 * (l.beAttackedPointL + l.beAttackedPointR) + "px", top: b + 20 - l.height + "px" });
    ...
    ViewProducePlant = function (b) {
        ...
        innerText($("spCoolTime"), a.coolTime + " sec");
    ...
    ViewCardTitle = function (b, c) {
        ...
        var f = $("dTitle"),
            a = b.prototype;
        f.innerHTML =
            a.CName + "<br>Cooldown: " + a.coolTime + " sec<br>" + (oS.DKind && a.night ? '<span style="color:#F00">Nocturnal - sleeps during the day</span><br>' + a.Tooltip : a.Tooltip || '<span style="text-align:left">' + a.Produce + "</span>");
    ...
    ViewPlantTitle = function (b) {
        var f = $("dTitle"),
            ...
            c = e.PName.prototype,
            a = c.CName;
        !oS.CardKind && ((a += "<br>Cooldown: " + c.coolTime + " sec<br>" + c.Tooltip), !e.CDReady && (a += '<br><span style="color:#F00">Reloading...</span>'));
        !e.SunReady && (a += '<br><span style="color:#F00">Not enough sun!</span>');
        f.innerHTML = a;
        ...
        if (oS.Chose < 1) {
            while (b--) {
                (c = (d = ArCard[b]).PName.prototype).SunNum > oS.SunNum
                    ? (d.SunReady && (d.SunReady = 0), ($(d.DID).childNodes[0].style.top = "-60px"))
                    : (!d.SunReady && (d.SunReady = 1), d.CDReady && ($(d.DID).childNodes[0].style.top = 0));
            }
        } else {
            while (b--) {
    ...
    ChosePlant = function (h, d) {
        ...
        !oS.CardKind
            ? EditImg(
                  NewImg("MovePlant", c[j.StaticGif], "left:" + b - 0.5 * (j.beAttackedPointL + j.beAttackedPointR) + "px;top:" + a + 20 - j.height + "px;z-index:254", EDAll).cloneNode(false),
                  "MovePlantAlpha",
                  "",
                  { visibility: "hidden", filter: "alpha(opacity=40)", opacity: 0.4, zIndex: 30 },
                  EDAll
              )
            : (NewImg("MovePlant", j.PicArr[j.StandGif], "left:" + (b - 0.5 * (j.beAttackedPointL + j.beAttackedPointR)) + "px;top:" + (a + 20 - j.height) + "px;z-index:254", EDAll),
              NewImg("MovePlantAlpha", j.PicArr[j.StandGif], "visibility:hidden;filter:alpha(opacity=40);opacity:0.4;z-index:30", EDAll));
        while (e--) {
    ...
    ChoseShovel = function (a) {
        ...
        WhichMouseButton(a) < 2 &&
            (SetHidden($("imgShovel")),
            NewImg("tShovel", "images/interface/Shovel.png", "left:" + (a.clientX - 10) + "px;top:" + (a.clientY + document.body.scrollTop - 17) + "px;z-index:1", EDAll),
            (oS.Chose = -1),
              ...
              oSym.addTask(
                  ...
                  function (q, p, n, j, l, k, m, i) {
                      if (ArSun[q] && ArSun[q].C) {
                          SetStyle($(q), { left: (p = p + j * k) + "px", top: (n = n + Number(l[0])) + "px" });
                          l.shift();
                          --m;
    ...
    MoveClickSun = function (b) {
        ...
        (function (k, l, n, s, m, r, j, q, p) {
            (m -= q) > n
                ? (SetStyle($(k), { left: m + "px", top: (r -= p) + "px" }), oSym.addTask(j, arguments.callee, [k, l, n, s, m, r, (j += 0.3), q, p]))
                : (SetStyle($(k), { left: n + "px", top: s + "px" }),
                  Number(ESSunNum.innerHTML) != oS.SunNum && (oS.SunNum = Math.min(Number(ESSunNum.innerHTML), oS.SunNum)),
                  innerText(ESSunNum, (oS.SunNum = Math.min(oS.SunNum + l.N, 9990))),
                  MonitorCard(),
                  delete ArSun[k],
    ...
    ShowLargeWave = function (a) {
        ...
        oSym.addTask(
            4,
            function (b, c, d) {
                SetStyle($("LargeWave"), { width: (b -= 57.2) + "px", height: (c -= 6.8) + "px", left: 500 - b * 0.5 + "px", top: 300 - c * 0.5 + "px" });
                b > 286
    ...
    ShowFinalWave = function () {
        var a = function (b) {
            ...
            oSym.addTask(
                4,
                function (c, e, d) {
                    SetStyle($("FinalWave"), { width: (c -= 50.4) + "px", height: (e -= 14.2) + "px", left: 500 - c * 0.5 + "px", top: 300 - e * 0.5 + "px" });
                    c > 252
    ...
    GetNewCard = function (a, b, c) {
        ...
        oSym.Init(
            function (d, e) {
                ++d < 100
                    ? (SetAlpha(e, d, d * 0.01), oSym.addTask(4, arguments.callee, [d, e]))
                    : (function () {
                          StopAudio("winmusic");
    ...
    GotoAuthorWebsite = function (b) {
        PlayAudio("tap");
        var a = "http://lonelystar.org";
        confirm("Login and auto-save isn't available on this version.\n\nIf you want to use this feature, click the button 'Accept' to go to the original author's website and use it from there (lonelystar.org)") && (location.href = a);
    },
    ShowLoginDiv = function () {
        $User.isAuthorWebsite ? (PlayAudio("tap"), SetBlock($("dLogin"))) : GotoAuthorWebsite("login and auto-save. (the original website is in chinese so ignore this lol)");
    },
    GameLogin = function (h) {
        if (!CheckLogin()) {
            return alert("Username can only contain 3-10 Chinese characters, letters, numbers, or underscores.\n\nPassword can only contain 3-20 letters, numbers, or underscores.");
        }
        var a,
            g,
            f,
        ...
        NewEle(
            ...
            "script",
            0,
            { src: d[e.DataInx][1] + "asp/User" + (h ? "Reg" : "Login") + ".asp?l=" + escape(oS.LevelName) + "&Username=" + $("txtName").value + "&UserPass=" + $("txtPass").value, type: "text/javascript" },
            document.body
        );
    },
    GameLogout = function () {
        var a = $User.Visitor,
            ...
            d = $User.Server,
            b = d.List;
        ClearChild($("JSPVZAjax")), NewEle("JSPVZAjax", "script", 0, { src: b[d.DataInx][1] + "asp/UserLogout.asp", type: "text/javascript" }, document.body), SetNone($("dLogin"));
    ...
    SelectModal = function (g) {
        ...
        if (g > 31) {
            alert("Sorry, this level is not yet available.\nPlease play other levels first!");
            return;
        }
        ...
        !$("dText1") &&
            a.insertBefore(
                NewEle(
                    ...
                    {
                        innerHTML:
                            '<span style="line-height:23px;font-size:15px;font-family:SimHei;color:#F60;top:32px">Welcome to the <span style="font-family:Verdana;font-weight:700">JS</span> version of Plants vs. Zombies. This program is a personal work and is unrelated to any company. <span style="font-family:Verdana;font-weight:700">LonelyStar</span> reserves all copyrights to this program, and materials belong to POPCAP.</span><br><br><div style="text-align:center"><b><a style="color:#FF0;font-size:15px;text-decoration:none" href="http://www.lonelystar.org/" target="_blank">Original Author\'s Homepage</a>&nbsp;&nbsp;&nbsp;<a style="color:#FF0;font-size:15px;text-decoration:none" href="https://github.com/lvplay2/jspvz" target="_blank">Translated by lvplay2 on GitHub</a>&nbsp;&nbsp;&nbsp;<a href="http://www.xiazai.com" target="_blank" style="color:#FF0;font-size:15px;text-decoration:none">Partner: A5 Download</a></b></div>',
                    },
                    0
                ),
                a.firstChild
    ...
    LoadLvl = function (e, c) {
        ...
        oSym.Init(
            function (g, f) {
                ...
                NewEle("JSPVZ", "script", 0, { src: "level/" + (oS.Lvl = g) + ".js", type: "text/javascript" }, document.getElementsByTagName("head").item(0));
            },
            [e && b ? 0 : e]
        );
    ...
    PauseGame = function (c, a) {
        ...
        $("dPauseAD").innerHTML =
            $User.Client.PC && oS.CenterContent
...
($SSml = function (d, c, a) {
    ...
    (Ajax = function (a, e, d, c) {
        var b;
        (b = window.XMLHttpRequest ? new XMLHttpRequest() : new window.ActiveXObject("Microsoft.XMLHTTP")) &&
            (c &&
                (b.onreadystatechange = function () {
                    b.readyState == 4 && b.status == 200 && c(b.responseText);
                }),
            b.open(e, a, true),
            e == "get" ? b.send(null) : (b.setRequestHeader("Content-Type", "application/x-www-form-urlencoded;charset=UTF-8"), b.send(d)));
    }),
    (ShowAD = function (b, a) {
    ...
    (NewAudio = $User.HTML5
        ? function (b) {
              ...
              var f = document.createElement("audio"),
                  ...
                  g = b.loop,
                  m,
                  h = { mp3: "audio/mpeg", ogg: "audio/ogg", aac: "audio/mp4" },
                  k = b.preload,
                  l = b.callback,
                  j = ["mp3", "ogg"],
                  e = j.length,
