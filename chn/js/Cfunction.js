var $User = (function () {
        ...
        return {
            ...
            Visitor: { UserName: "游客", UserAuthority: 0, Progress: 1, SelectServerT: 0, NowStep: 1, TimeStep: 10, SaveLvl: 1, SaveLvlCallBack: null },
        };
    })(),
    oSym = {
        Init: function (b, a) {
    ...
    oS = {
        ...
        LoadTips: function () {
            var b = NewEle("dTips", "div", "position:absolute;color:#fff;top:450px;width:100%;text-align:center;font-size:16px", "", EDAll),
                a = [
                    "亲,不要说偶没提示你,本游戏自带调速功能,在游戏选项里哦,别再抱怨节奏慢了!亲!!",
                    "本游戏有选关功能,请到游戏选项里选择!",
                    ...
                    "这网页版开发速度也太慢了!没错,由于个人业余时间很有限,所以请大家谅解!",
                    ...
                    "这里有木有人啊?这儿必须有活人的,打开聊天按钮加入到在线交流行列!",
                    "为啥这么卡?如果你是IE6-8的用户,请使用IE9,Chrome,Firefox,Opera等更好的浏览器!",
                    "如果你支持偶,非常感谢,请一如既往继续支持偶!顺便帮偶点一下那啥~。。。",
            ...
            if (f.CenterContent) {
                ...
                if (oS.MustAllReady && oS.DisplayAD) {
                    ...
                    if (b > 0) {
                        ...
                        (function (g) {
                            var h = $("ADTimer");
                            h && ($("ADTimer").innerHTML = '<span style="text-decoration:underline;color:#ff0">倒计时' + g + "秒,跳过广告</span>");
                ...
                $("dAdFlash").innerHTML =
                    ...
                    Math.random() +
                    '"></iframe><br><div style="font-family:arial,sans-serif;font-size:11px;position:absolute;left:300px;width:200px">Google提供的广告</div>';
    ...
    ViewCardTitle = function (b, c) {
        ...
        var f = $("dTitle"),
            a = b.prototype;
        f.innerHTML =
            a.CName + "<br>冷却时间:" + a.coolTime + "秒<br>" + (oS.DKind && a.night ? '<span style="color:#F00">夜行性的--在白天会睡觉</span><br>' + a.Tooltip : a.Tooltip || '<span style="text-align:left">' + a.Produce + "</span>");
    ...
    ShowLoginDiv = function () {
        $User.isAuthorWebsite ? (PlayAudio("tap"), SetBlock($("dLogin"))) : GotoAuthorWebsite("登录和保存功能");
    },
