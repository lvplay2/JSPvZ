var CZombies = (function (b, a) {
                        ...
                        ? (h.beAttacked && !h.isAttacking && h.JudgeAttack(),
                          !h.isAttacking
                              ? (c = h.AttackedRX -= d = h.Speed) < -50
                                  ...
                                  : (c < 100 && !h.PointZombie && ((h.PointZombie = 1), !oS.CardKind && (StopMusic(), PlayAudio("losemusic", false)), h.ChangeR({ R: f, ar: [oS.R - 1], CustomTop: 400 - h.height + h.GetDY() })),
                                    (h.ZX = h.AttackedLX -= d),
                ...
                ChkActs1: function (g, e, h, d) {
                    ...
                    !(g.FreeFreezeTime || g.FreeSetbodyTime)
                        ? (g.beAttacked && !g.isAttacking && g.JudgeAttack(),
                          !g.isAttacking ? ((g.AttackedLX += c = g.Speed) > oS.W ? (h.splice(d, 1), g.DisappearDie(), (f = 0)) : ((g.ZX = g.AttackedRX += c), (g.Ele.style.left = Math.ceil((g.X += c)) + "px"), (f = 1))) : (f = 1))
                        : (f = 1);
                    return f;
                },
                GetDX: function () {
                ...
                ChangeR: function (e) {
                    ...
                    g.length
                        ? ((l = !d.WalkDirection ? -5 : 5),
                          ...
                          SetStyle(f, { left: d.X + "px", top: (d.pixelTop = j == undefined ? GetY(q) - d.height + d.GetDY() : j) + "px", zIndex: (d.zIndex = 3 * q + 1) }),
                ...
                ? (g.beAttacked && !g.isAttacking && g.JudgeAttack(),
                  ...
                  !g.isAttacking
                      ? (a = g.AttackedRX -= b = g.Speed) < -50
                          ...
                          : (a < 100 && !g.PointZombie && ((g.PointZombie = 1), !oS.CardKind && (StopMusic(), PlayAudio("losemusic", false)), g.ChangeR({ R: d, ar: [oS.R - 1], CustomTop: 400 - g.height + g.GetDY() })),
                            (g.ZX = g.AttackedLX -= b),
        ...
        ChkActs1: function (e, b, f, a) {
            ...
            !(e.FreeFreezeTime || e.FreeSetbodyTime)
                ? (e.beAttacked && !e.isAttacking && e.JudgeAttack(),
                  (c = e.id),
                  !e.isAttacking ? ((e.AttackedLX += 3.5) > oS.W ? (f.splice(a, 1), e.DisappearDie(), (d = 0)) : ((e.ZX = e.AttackedRX += 3.5), (e.Ele.style.left = Math.ceil((e.X += 3.5)) + "px"), (d = 1))) : (d = 1))
                : (d = 1);
            return d;
        },
            ...
            oSym.addTask(
                ...
                function (d, c) {
                    ...
                    f &&
                        ...
                        !f.FreeFreezeTime &&
                        !f.FreeSetbodyTime &&
                        ((e = $Z[c]) ? (e.getHit0(e, 10, 0), oSym.addTask(10, arguments.callee, [d, c])) : ((f.isAttacking = 0), (f.EleBody.src = f.PicArr[f.NormalGif]), f.TurnLeft(f)));
                },
                [b, a]
            );
        },
    ...
    OrnIZombies = (function () {
        ...
        return InheritO(OrnNoneZombies, { Ornaments: 1, OrnLostNormalGif: 9, OrnLostAttackGif: 10, getHit: a, getHit0: a, getHit1: a, getHit2: a, getHit3: a });
    })(),
        ...
        JudgeAttack: function () {
            ...
            for (f = c - 2; f <= c; f++) {
                ...
                for (
                    ...
                    (p = h[d + f + "_" + a--]) &&
                    (p.EName != "oBrains"
                        ? p.AttackedRX >= e && p.AttackedLX < b && p.canEat && ((a = -1), (g.JudgeAttack = CZombies.prototype.JudgeAttack), g.NormalAttack(g.id, p.id, p.AttackedLX))
                        : p.AttackedRX >= b && p.AttackedLX < b && ((a = -1), (g.JudgeAttack = CZombies.prototype.JudgeAttack), (g.NormalAttack = CZombies.prototype.NormalAttack)(g.id, p.id)))
                ) {}
            }
        },
    ...
    oNewspaperZombie = InheritO(OrnIIZombies, {
        ...
        getFirePea: function (f, b, e) {
            ...
            (f.HP -= b) < f.BreakPoint
                ? ((f.getFirePea = OrnNoneZombies.prototype.getFirePea), f.GoingDie(f.PicArr[[f.LostHeadGif, f.LostHeadAttackGif][f.isAttacking]]), (f.getHit = f.getHit0 = f.getHit1 = f.getHit2 = f.getHit3 = function () {}))
    ...
    oScreenDoorZombie = InheritO(oNewspaperZombie, {
        ...
        getHit0: function (c, a, b) {
            b == c.WalkDirection
                ...
                : (c.HP -= a) < c.BreakPoint && (c.GoingDie(c.PicArr[[c.LostHeadGif, c.LostHeadAttackGif][c.isAttacking]]), (c.getHit = c.getHit0 = c.getHit1 = c.getHit2 = c.getHit3 = function () {}));
        },
        CheckOrnHP: function (g, h, d, c, f, b, a) {
            var e = OrnNoneZombies.prototype;
            (g.OrnHP = d -= c) < 1 &&
    ...
    oAquaticZombie = InheritO(OrnNoneZombies, {
        ...
        ChkActsL1: function (f, e, g, d) {
            ...
            f.AttackedLX < GetX(9) &&
                ...
                NewEle((a = b + "_splash"), "div", "position:absolute;background:url(images/interface/splash.png);left:61px;top:" + (f.height - 88) + "px;width:97px;height:88px;over-flow:hidden", 0, f.Ele),
        ...
        ChkActs2: function (e, c, f, b) {
            ...
            !(e.FreeFreezeTime || e.FreeSetbodyTime)
                ? (e.beAttacked && !e.isAttacking && e.JudgeAttack(),
                  !e.isAttacking ? ((e.AttackedLX += a = e.Speed) > oS.W ? (f.splice(b, 1), e.DisappearDie(), (d = 0)) : ((e.ZX = e.AttackedRX += a), (e.Ele.style.left = Math.ceil((e.X += a)) + "px"), (d = 1))) : (d = 1))
                : (d = 1);
            return d;
        },
    ...
    oSnorkelZombie = InheritO(oDuckyTubeZombie1, {
        ...
        ChkActsL2: function (d, c, e, b) {
            ...
            !(d.FreeFreezeTime || d.FreeSetbodyTime) &&
                (d.AttackedLX > GetX(0)
                    ? (d.beAttacked && !d.isAttacking && d.JudgeAttack(), !d.isAttacking && ((d.AttackedRX -= a = d.Speed), (d.ZX = d.AttackedLX -= a), (d.Ele.style.left = Math.floor((d.X -= a)) + "px")))
                    : d.beAttacked && ((d.WalkStatus = 0), (d.Altitude = 1), (d.EleBody.src = d.PicArr[(d.NormalGif = d.WalkGif0)]), SetVisible(d.EleShadow), (d.ChkActs = d.ChkActsL3)));
            return 1;
        },
        JudgeAttack: function () {
            var e = this,
        ...
        return InheritO(OrnNoneZombies, {
            ...
            BirthCallBack: function (h) {
                ...
                !b[d]
                    ? ((f = NewEle("dIceCar" + d, "div", "position:absolute;z-index:1;left:145px;top:" + (GetY(d) - 65) + "px;width:800px;height:72px", 0, EDPZ)),
                      NewImg("", "images/interface/blank.png", "position:absolute;clip:rect(0,auto,auto,800px);width:800px;height:72px;left:5px;background:url(images/Zombies/Zomboni/ice.png) repeat-x", f),
            ...
            ChkActs: function (e, j, q, k) {
                ...
                (r = e.AttackedRX -= b = e.Speed) < -50
                    ...
                    : (r < 100 && !e.PointZombie && ((e.PointZombie = 1), !oS.CardKind && (StopMusic(), PlayAudio("losemusic", false)), e.ChangeR({ R: j, ar: [oS.R - 1], CustomTop: 400 - e.height + e.GetDY() })),
                      (e.ZX = e.AttackedLX -= b),
        ...
        JudgeAttack: function () {
            ...
            for (e = c - 2; e <= c; e++) {
                ...
                for (
                    ...
                    (p = g[d + e + "_" + a--]) &&
                    (p.EName != "oBrains"
                        ? p.AttackedRX >= b && p.AttackedLX < b && ((a = -1), (f.JudgeAttack = CZombies.prototype.JudgeAttack), f.NormalAttack(f.id, p.id, p.AttackedLX))
                        : p.AttackedRX >= b && p.AttackedLX < b && ((a = -1), (f.JudgeAttack = CZombies.prototype.JudgeAttack), (f.NormalAttack = CZombies.prototype.NormalAttack)(f.id, p.id)))
                ) {}
            }
        },
        AttackZombie2: function (c, b, a) {
        ...
        NormalAttack: function (d, b, g) {
            ...
            oSym.addTask(
                ...
                function (m, j, i, l, q) {
                    ...
                    h &&
                        ((k = $P[j]) && k.Stature > 0
                            ? ((h.AttackedRX = (h.X = (h.AttackedLX = h.ZX = r = k.AttackedRX) - (h.beAttackedPointL = 45)) + (h.beAttackedPointR = 100)), SetStyle(i, { left: h.X + "px" }), (h.EleShadow.style.left = "45px"), n())
